...
// Storage exposes a service.Allocator that is backed by etcd.
...
// Storage implements allocator.Interface and service.RangeRegistry
var _ allocator.Interface = &Storage{}
var _ service.RangeRegistry = &Storage{}

// NewStorage returns an allocator that is backed by Storage and can manage
// persisting the snapshot state of allocation after each allocation is made.
func NewStorage(alloc allocator.Snapshottable, baseKey string, resource unversioned.GroupResource, storage storage.Interface) *Storage {
	return &Storage{
		alloc:    alloc,
		storage:  storage,
		baseKey:  baseKey,
...
func (e *Storage) Allocate(offset int) (bool, error) {
	e.lock.Lock()
	defer e.lock.Unlock()
...
func (e *Storage) AllocateNext() (int, bool, error) {
	e.lock.Lock()
	defer e.lock.Unlock()
...
func (e *Storage) Release(item int) error {
	e.lock.Lock()
	defer e.lock.Unlock()
...
func (e *Storage) tryUpdate(fn func() error) error {
...
func (e *Storage) Refresh() (*api.RangeAllocation, error) {
	e.lock.Lock()
	defer e.lock.Unlock()
...
func (e *Storage) Get() (*api.RangeAllocation, error) {
	existing := &api.RangeAllocation{}
...
// allocation.
func (e *Storage) CreateOrUpdate(snapshot *api.RangeAllocation) error {
	e.lock.Lock()
	defer e.lock.Unlock()
...
func (e *Storage) Has(item int) bool {
	e.lock.Lock()
	defer e.lock.Unlock()
