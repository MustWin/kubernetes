...
func newStorage(t *testing.T) (*ReplicaSetStorage, storagefactory.TestClientServer) {
	internalStorage, server := registrytest.NewStorage(t, factory, "extensions")
...
func TestGenerationNumber(t *testing.T) {
	...
	stgRS, err := storage.ReplicaSet.Get(ctx, rs.Name)
	if err != nil {
		t.Errorf("unexpected error: %v", err)
	}
	storedRS, _ := stgRS.(*extensions.ReplicaSet)
